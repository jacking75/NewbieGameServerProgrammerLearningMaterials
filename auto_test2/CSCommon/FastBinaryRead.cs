...
namespace CSCommon
{
    ...
    {
        public static bool Boolean(byte[] bytes, Int32 offset)
        {
            return (bytes[offset] == 0) ? false : true;
        }
        public static bool Boolean(ReadOnlySpan<byte> bytes, Int32 offset)
        {
            return (bytes[offset] == 0) ? false : true;
        }

        public static byte Byte(byte[] bytes, Int32 offset)
        {
            return bytes[offset];
        }
        public static byte Byte(ReadOnlySpan<byte> bytes, Int32 offset)
        {
            return bytes[offset];
        }

        public static byte[] Bytes(byte[] bytes, Int32 offset, Int32 count)
        {
        ...
        public static sbyte SByte(byte[] bytes, Int32 offset)
        {
            return (sbyte)bytes[offset];
        }
        public static sbyte SByte(ReadOnlySpan<byte> bytes, Int32 offset)
        {
            return (sbyte)bytes[offset];
        }

        public static unsafe float Single(byte[] bytes, Int32 offset)
        {
            if (offset % 4 == 0)
            {
